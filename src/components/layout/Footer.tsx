    ...
    <footer className="bg-muted/50 border-t mt-12">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-2">CryptoDash</h3>
            <p className="text-sm text-muted-foreground">
              Your portal to the cryptocurrency world.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cryptocurrencies" className="text-sm text-foreground hover:text-primary">All Cryptos</Link></li>
              <li><Link to="/dashboard" className="text-sm text-foreground hover:text-primary">Dashboard</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} CryptoDash. All rights reserved. Data provided for informational purposes only.
          </p>
        </div>
      </div>
    </footer>
